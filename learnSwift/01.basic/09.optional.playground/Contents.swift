 ...
 */
print("\n")
var myName6: String! = "YJ"
print(myName6)
myName6 = nil
//암시적 추출 옵셔널이라도 옵셔널이므로 당연히 바인딩을 사용할 수 있다.
if let name = myName6 {
    print("MY NAME IS \(name)")
} else {
    print("myName6 == nil")
}
myName.isEmpty //error가 아니네...?

/**
 옵셔너을 사용할 떄는 강제 추출 또는 암시적 추출 옵셔널을 사용하기보다는 옵셔널 바인딩, nil 병합 연산자를 비롯해 옵셔널 체이닝 등을 사용하는 것이 훨씬 안전하다.
 */
